                ...
                <footer id="footer">
                    <div className="footer-top">
                        ...
                        <div className="row">
                            ...
                            <h3>Linguistics Software</h3>
                            <p>
                                Ferozpur Road, Lahore<br />
                                Pakistan <br />
                                <strong>Email:</strong> <br /> amna@Linguistics.co<br />azlan@Linguistics.co 
                            </p>
                            </div>
                    ...
                    <div className="container d-md-flex py-4">
                        ...
                        <div className="copyright" style={{color: 'rgba(55, 64, 85, 0.9) !important'}}>
                            © Copyright <strong><span>Linguistics</span></strong>. All Rights Reserved
                        </div>
                        </div>
