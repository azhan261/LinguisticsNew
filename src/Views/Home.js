    ...
    render(){
        return(
            ...
            <main id="main">
                  ...
                  <div className="row gy-4">
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                      <div className="icon-box iconbox-yellow">
                        ...
                        <p>Our Team at Linguistics is working on creating an International Payment System that would modernize the lives of the people.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={200}>
                      <div className="icon-box iconbox-orange ">
                        ...
                        <p>Optimal Hosting service is essential, that is why our Team at Linguistics Hosting Service Provider is working to create a hosting service suitable for all.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={300}>
                      <div className="icon-box iconbox-pink">
                        ...
                        <p>Having a fool-proof &amp; affordable security system  is essential. Our Team at Linguistics is working to create security systems that are affordable and easy to install.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                      <div className="icon-box iconbox-blue">
                        ...
                        <p>Safe medical assistance is extremely important for Linguistics. Linguistics Health assistance is coming soon.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={200}>
                      <div className="icon-box iconbox-orange ">
                        ...
                        <p>Linguistics is branching out into multiple sectors. Analytics is another branch is Linguistics which is coming soon.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={300}>
                      <div className="icon-box iconbox-pink">
                        ...
                        <p>Linguistics has brought it all, food, Grocery, and other consumable goods. Linguistics Delivery is coming soon in Pakistan.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                      <div className="icon-box iconbox-blue">
                        ...
                        <p>Linguistics is developing an International Job portal which would allow easy access, premium job offers and much more.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={200}>
                      <div className="icon-box iconbox-orange ">
                        ...
                        <p>Linguistics is developing an International ecommerce digital portal. Coming Soon Internationally.</p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={300}>
                      <div className="icon-box iconbox-pink">
                        ...
                        <p>Our aim at Linguistics is to optimize Courier system in Pakistan. Our project is coming out soon.</p>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <Accordion>
                            <Accordion.Item eventKey="0">
                              ...
                              <Accordion.Body>
                                  ...
                                  <b>Level 5</b><br />
                                  Internships <br />
                                  Freelancing portal access by Linguistics <br />  
              ...
              <section id="seminar" className="team section-bg">
                <div className="container">
                  <div className="section-title">
                    <h2 style={{color: 'rgba(55, 64, 85, 0.9) !important', fontSize: '40px'}}>Seminars</h2>
                  </div>
                  <div className="align-middle text-center">
                  At Linguistics, we strive to make the current generation of Pakistan capable enough in becoming leading individuals in the IT industry. We believe that Pakistan has a lot of potential and talent, however, unfrotunately, the students do not have the exposure and direction required in order to achieve success.<br />
                  For this very reason, to create an awarness among students that they must aquire skils in order to go into the market, we conduct Seminars in collaborations with various prestigious educational instituions, private and goverment. 
                  </div>
                  <br />
              ...
              <div class="col-lg-7 col-md-6 d-flex justify-content-center">
                <div class="align-middle">
                  ...
                  as serving as chief financial officer in Linguistics. His primary 
                ...
                <div className = "row">
                    ...
                    <div className="member">
                        <div className="member-img">
                          <img src="assets/img/SLK-SEM-2.jpg" className="img-fluid" style ={{height: "300px", width:"500px"}}  alt="" />
                        </div>
                    </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12">
                    <div className="member">
                        <div className="member-img">
                          <img src="assets/img/SLK-SEM-3.jpg" className="img-fluid" style ={{height: "300px", width:"500px"}}  alt="" />
                        </div>
                    </div>
                    </div>
                  </div>
                  ...
                  <div className = "row">
                    ...
                    <div className="member">
                        <div className="member-img">
                          <img src="assets/img/SLK-SEM-5.jpg" className="img-fluid" style ={{height: "300px", width:"500px"}}  alt="" />
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="member">
                        <div className="member-img">
                          <img src="assets/img/SLK-SEM-4.jpg" className="img-fluid" style ={{height: "300px", width:"500px"}}  alt="" />
                        </div>
                    </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-12">
                    <div className="member">
                        <div className="member-img">
                          <img src="assets/img/SLK-SEM-1.jpg" className="img-fluid" style ={{height: "300px", width:"500px"}}  alt="" />
                        </div>
                    </div>
                    </div>
                  </div>
              ...
              <section id="careers" className="faq section-bg">
                <div className="container">
                  <div className="section-title">
                    ...
                    <p>Email your resume and cover letter at recruitment@Linguistics.co</p>
                  </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="info-box mt-4">
                            ...
                            <p style={{color: 'rgba(55, 64, 85, 0.9) !important'}}>amna@Linguistics.co<br />azlan@Linguistics.co</p>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="info-box mt-4">
